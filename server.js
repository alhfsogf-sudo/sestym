...
const requiredEnvVars = ['DISCORD_TOKEN', 'CLIENT_ID', 'CLIENT_SECRET', 'CALLBACK_URL', 'DATABASE_URL', 'SESSION_SECRET'];
...
db.initTables()
  .then(() => console.log('✅ الموقع متصل بقاعدة البيانات (PostgreSQL)'))
